  ...
  return (
    <section className="benefits-section" id='benefits'>
      ...
      <div className="benefits_benefits">
          <Benefit icon={faPeopleGroup}  title='Διατροφική Διαφάνεια για τους Πελάτες σας' description='Με το NutriScanner, οι πελάτες μπορούν να σκανάρουν το QR code και να δουν αμέσως τις διατροφικές πληροφορίες για κάθε προϊόν. Αυξήστε την εμπιστοσύνη τους προς την επιχείρησή σας με διαφάνεια και ακρίβεια' />
